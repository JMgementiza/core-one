              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <?php 
                    ...
                    if ($_GET['registration'] == "emptyfields") {
                      echo '<p>Fill in all fields</p>';
                    }
                    else if ($_GET['registration'] == "invalidcharacters") {
                      echo '<p>You used an invalid character!</p>';
                    }
                    else if ($_GET['registration'] == "invalidemail") {
                      echo '<p>Invalid email!</p>';
                    }
                    else if ($_GET['registration'] == "invalidemail&characters") {
                      echo '<p>Invalid email and characters!</p>';
                    }
                  }
                  else if ($_GET["registration"] == "success") {
                    echo '<p>Patient Regsitered Successfully!</p>';
                  }
